...
function Navbar() {
    const LINK_CSS = "bg-grey bg-opacity-70 transition duration-300 hover:bg-opacity-90 cursor-pointer mx-1 p-2 rounded-3xl text-white font-bold w-24 text-center";
    const ACTIVE_LINK_CSS = "bg-blue transition duration-300 cursor-pointer mx-1 p-2 rounded-3xl text-white font-bold w-24 text-center"; // CSS class for active link
