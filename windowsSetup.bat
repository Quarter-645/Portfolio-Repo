...
netsh interface portproxy add v4tov4 listenport=443 listenaddress=0.0.0.0 connectport=443 connectaddress=172.29.185.89

echo Port forwarding set up from Windows port 443 to WSL IP 172.29.185.89 port 443
pause
